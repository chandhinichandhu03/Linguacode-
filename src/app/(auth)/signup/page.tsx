...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-purple-500/20 via-background to-primary/10 animate-gradient" />
      <div className="absolute top-1/3 -right-32 w-64 h-64 bg-primary/20 rounded-full blur-3xl animate-float" />
      <div className="absolute bottom-1/3 -left-32 w-64 h-64 bg-purple-500/20 rounded-full blur-3xl animate-float delay-300" />
